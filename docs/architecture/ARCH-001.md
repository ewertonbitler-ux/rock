...
| Engagement Context | Approved for specification | Accepted [PRD-002](../prd/PRD-002.md) and [ADR-004](../adr/ADR-004.md); EPKG-0004 has not been created and no Engagement code exists. |
...
| Engagement | Governed engineering engagements, ownership, participation, and traceability | Approved for specification; not implemented | Must conform to repository authority and publish bounded contracts without infrastructure dependencies. |
...
- New Engineering Domains require an accepted PRD and a separate EPKG; a further ADR is required only for consequential or cross-cutting architecture decisions. Engagement is approved for specification under accepted [PRD-002](../prd/PRD-002.md) and [ADR-004](../adr/ADR-004.md), but EPKG-0004 has not been created and implementation is not authorized.
